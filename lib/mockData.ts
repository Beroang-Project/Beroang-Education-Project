...
export const MOCK_CLASSES: Class[] = [
  ...
  // ─── 12 Subject Classes Added ─────────────────────────
  {
    id: 'c4', name: 'X IPA 2', subject: 'Matematika',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
  {
    id: 'c5', name: 'XI IPA 1', subject: 'Fisika',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
  {
    id: 'c6', name: 'XI IPA 2', subject: 'Kimia',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
  {
    id: 'c7', name: 'XI IPS 1', subject: 'Sejarah',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
  {
    id: 'c8', name: 'XII IPS 1', subject: 'PKn',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
  {
    id: 'c9', name: 'XII IPS 2', subject: 'Sosiologi',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
  {
    id: 'c10', name: 'X Bahasa 1', subject: 'Bahasa Inggris',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
  {
    id: 'c11', name: 'X IPA 3', subject: 'Seni Budaya',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
  {
    id: 'c12', name: 'X IPS 1', subject: 'Prakarya',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
  {
    id: 'c13', name: 'XI Bahasa 1', subject: 'Penjasorkes',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
  {
    id: 'c14', name: 'XI IPS 2B', subject: 'Geografi',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
  {
    id: 'c15', name: 'XII IPA 1', subject: 'Informatika',
    teacherId: 'teacher1', studentIds: [],
    gradeWeights: { assignments: 40, quizzes: 30, p5Project: 30 }, kkm: 75,
  },
];
